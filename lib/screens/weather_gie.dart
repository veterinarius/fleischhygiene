...
class WeatherGIE extends StatefulWidget {
  const WeatherGIE({Key? key}) : super(key: key);

  @override
  _WeatherGIEState createState() => _WeatherGIEState();
}

class _WeatherGIEState extends State<WeatherGIE> {
